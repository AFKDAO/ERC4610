...
error DelegatedQueryForNonexistentToken();
...
/**
 * @dev ERC4610A is an extension of ERC721A
 */
contract ERC4610A is Context, ERC165, IERC4610, IERC721Metadata {
    ...
    function approve(address to, uint256 tokenId) public override {
        address owner = ERC4610A.ownerOf(tokenId);
    ...
    function delegatorOf(uint256 tokenId) public view virtual override returns (address) {
        if (!_exists(tokenId)) revert DelegatedQueryForNonexistentToken();
